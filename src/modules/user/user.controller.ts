...
import { findByCompanyId } from '../company/company.service';
...
import { TFindUserSchema } from '../../modules/user/user.schema';
import { addUserCredit } from '../user-credit/user-credit.service';
...
export const add = expressAsyncHandler(
  async (req: Request, res: any, next: NextFunction) => {
    ...
    let userCredit = await addUserCredit(addedUser);
    ...
    await registerTokenAndCreditForUser(addedUser.id, tokenObject, userCredit);
